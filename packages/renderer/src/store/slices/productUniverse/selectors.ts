...
export const selectProductCategories = createSelector(selectProductUniverse, (state) => state.categories)
export const selectRecommendations = createSelector(selectProductUniverse, (state) => state.recommendations)
